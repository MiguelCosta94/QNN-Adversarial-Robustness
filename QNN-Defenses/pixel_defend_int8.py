...
from art.defences.preprocessor.pixel_defend_int8 import PixelDefend_Int8
...
def load_configs():
    ...
    required_cfgs = ['dataset_id', 'qnn_source_int8', 'datasets_path', 'pixel_cnn']
...
def main():
    ...
    qnn = b.get_ml_quant_model(cfgs['qnn_source_int8'])
    ...
    x_test = np.fromfile(x_test_file, dtype=np.int8)
    ...
    # Setup PixelDefend
    pixel_defend = PixelDefend_Int8(clip_values=(-128, 127), eps=cfgs['pd_eps'], pixel_cnn=pixel_cnn,
