...
from art.attacks.evasion.geometric_decision_based_attack_int16 import GeoDA_Int16
...
def load_configs():
    ...
    parser.add_argument("--geoda_bin_search_tol", type=float, default=0.0001, help="")
    parser.add_argument("--geoda_sub_dim", type=int, default=75, help="")
    parser.add_argument("--geoda_init_size", type=int, default=100, help="")
...
def main():
    ...
    attack = GeoDA_Int16(estimator=art_classifier, bin_search_tol=cfgs['geoda_bin_search_tol'], sub_dim=cfgs['geoda_sub_dim'],
                   init_size=cfgs['geoda_init_size'], batch_size=1)
