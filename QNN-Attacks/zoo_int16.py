...
from art.attacks.evasion.zoo_int16 import ZooAttack_Int16
...
def load_configs():
    ...
    parser.add_argument("--zoo_max_iter", type=int, default=10, help="")
    parser.add_argument("--zoo_binary_search_steps", type=int, default=5, help="")
    parser.add_argument("--zoo_initial_const", type=float, default=0.01, help="")
...
def main():
    ...
    attack = ZooAttack_Int16(classifier=art_classifier, max_iter=cfgs['zoo_max_iter'], binary_search_steps=cfgs['zoo_binary_search_steps'],
                        initial_const=cfgs['zoo_initial_const'], use_resize=False, batch_size=1)
