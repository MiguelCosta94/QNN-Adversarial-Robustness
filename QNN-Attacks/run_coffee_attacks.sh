...
#ANN_FLOAT='models-defense_enhanced/coffee_adv_float.h5'
...
#QNN_INT16='models-defense_enhanced/coffee_adv_int16.tflite'
...
#QNN_INT8='models-defense_enhanced/coffee_adv_int8.tflite'
...
python3 autoattack.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                    --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/autoattack' --autoattack_eps 0.009

echo "=============================================================="
echo "======================BOUNDARY================================"
python3 boundary.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                    --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/boundary' --boundary_delta 0.1 \
...
python3 boundary_int8.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int8 "$QNN_INT8" \
                        --logs_folder 'logs/coffee/boundary_int8' --boundary_delta 0.1 --boundary_epsilon 1.0 --boundary_max_iter 500

echo "=============================================================="
echo "======================BOUNDARY-INT16=========================="
python3 boundary_int16.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int16 "$QNN_INT16" \
                       --logs_folder 'logs/coffee/boundary_int16' --boundary_delta 0.1 --boundary_epsilon 1.0 --boundary_max_iter 500

echo "=============================================================="
echo "======================CW-L2==================================="
python3 cwl2.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/cwl2' --cwl2_max_iter 10 \
...
python3 cwlinf.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/cwlinf' --cwlinf_max_iter 10 --cwlinf_learning_rate 0.01

echo "=============================================================="
echo "======================DEEPFOOL================================"
python3 deepfool.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/deepfool' --deepfool_max_iter 100\
...
python3 ead.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/ead' --ead_max_iter 10 \
...
python3 square.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/square_l2' --square_norm 2 --square_max_iter 2000 \
                --square_eps 2.0 --square_p_init 0.8

echo "=============================================================="
echo "======================SQUARE-LINF============================="
python3 square.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/square_linf' --square_norm "inf" \
                --square_max_iter 1000 --square_eps 0.015 --square_p_init 0.05

echo "=============================================================="
echo "======================SQUARE-L2-INT8=========================="
python3 square_int8.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int8 "$QNN_INT8" \
                --logs_folder 'logs/coffee/square_l2_int8' --square_norm 2 --square_max_iter 2000 --square_eps 2.0 --square_p_init 0.8

echo "=============================================================="
echo "======================SQUARE-LINF-INT8========================"
python3 square_int8.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int8 "$QNN_INT8" \
                --logs_folder 'logs/coffee/square_linf_int8' --square_norm "inf" --square_max_iter 1000 --square_eps 0.015 --square_p_init 0.05
...
python3 square_int16.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int16 "$QNN_INT16" \
                --logs_folder 'logs/coffee/square_l2_int16' --square_norm 2 --square_max_iter 2000 --square_eps 2.0 --square_p_init 0.8

echo "=============================================================="
echo "======================SQUARE-LINF-INT16======================="
python3 square_int16.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int16 "$QNN_INT16" \
                --logs_folder 'logs/coffee/square_linf_int16' --square_norm "inf" --square_max_iter 1000 --square_eps 0.015 --square_p_init 0.05

echo "=============================================================="
echo "======================ZOO====================================="
python3 zoo.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --ann_float "$ANN_FLOAT"  \
                --qnn_int16 "$QNN_INT16" --qnn_int8 "$QNN_INT8" --logs_folder 'logs/coffee/zoo' --zoo_max_iter 10 --zoo_binary_search_steps 2 \
...
python3 zoo_int8.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int8 "$QNN_INT8" \
                    --logs_folder 'logs/coffee/zoo_int8' --zoo_max_iter 10 --zoo_binary_search_steps 2 --zoo_initial_const 0.01

echo "=============================================================="
echo "======================ZOO-INT16==============================="
python3 zoo_int16.py --dataset_id "$DATASET_ID" --dataset_size "$DATASET_SIZE" --num_classes "$NUM_CLASSES" --qnn_int16 "$QNN_INT16" \
                    --logs_folder 'logs/coffee/zoo_int16' --zoo_max_iter 10 --zoo_binary_search_steps 2 --zoo_initial_const 0.01