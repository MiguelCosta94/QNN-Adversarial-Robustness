...
from art.attacks.evasion.boundary_int16 import BoundaryAttack_Int16
...
def load_configs():
    ...
    parser.add_argument("--boundary_delta", type=float, default=0.1, help="")
    parser.add_argument("--boundary_epsilon", type=float, default=1.0, help="")
    parser.add_argument("--boundary_max_iter", type=int, default=500, help="")
    parser.add_argument("--boundary_init_size", type=int, default=100, help="")
...
def main():
    ...
    attack = BoundaryAttack_Int16(estimator=art_classifier, delta=cfgs['boundary_delta'],
